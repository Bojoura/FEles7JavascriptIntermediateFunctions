...
console.log("Aantal cum laude studenten:", cumLaudeCount);
...
console.log("cumLaude([6, 4, 5]) geeft", cumLaude([6, 4, 5]));
console.log("cumLaude([8, 9, 4, 6, 10]) geeft", cumLaude([8, 9, 4, 6, 10]));
...
const grades1 = [7, 9, 6, 8, 4];
const grades2 = [6, 4, 5];
const grades3 = [8, 9, 4, 6, 10];

console.log('highestGrade(grades1) geeft', highestGrade(grades1));
console.log('highestGrade(grades2) geeft', highestGrade(grades2));
console.log('highestGrade(grades3) geeft', highestGrade(grades3));